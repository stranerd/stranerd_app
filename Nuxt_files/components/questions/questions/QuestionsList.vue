<template>
	<div>
		...
		<div class="flex justify-content-between items-center gap-1 mb-1 mb-md-2 ">
			<Heading class="text-dark flex items-center flex-grow-1 d-none d-sm-inline" variant="1">
