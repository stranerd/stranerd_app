<template>
	<NuxtLink :to="`/sessions/${meta.id}`" class="gap-0-5">
		...
		<div class="flex-grow-1 text-truncate">
			<div class="flex justify-content-between align-items-center gap-0-5">
				<DynamicText :truncate="true" class="name">
					{{ meta.fullName }}
				</DynamicText>
				<DynamicText>{{ formatTime(meta.last.createdAt, true) }}</DynamicText>
			</div>
			<div class="flex align-items-center text-truncate gap-0-25">
				...
				<span
					...
					class="bg-success ms-auto flex align-items-center justify-content-center rounded-pill text-white"
