	...
	<Auth>
		<div class="w-full h-full flex bg-white">
			...
			<div class="flex flex-col items-center mt-6 md:justify-center lg:w-5/12 w-full p-4">
				<h1 class="md:block text-5xl hidden text-main_dark font-extrabold mb-8 text-center">Sign up today</h1>
				<div>
					<form class="flex flex-col gap-4" @submit.prevent="signup">
						...
						<div class="flex flex-col">
							<ion-label class="font-bold text-sm text-main_dark mb-2">Confirm Password</ion-label>
							<ion-input v-model="factory.cPassword" :size="24" placeholder="Confirm Password"
								position="floating"
								type="password"></ion-input>
							<DisplayError :error="factory.errors.cPassword" />
						</div>
						<ion-button class="w-full !capitalize mt-4" type="submit">
...
export default defineComponent({
	...
	components: { IonInput, IonButton, AuthProviders, Auth, IonSpinner, IonLabel },
