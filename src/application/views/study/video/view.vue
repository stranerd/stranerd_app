<template>
	<Justified>
		...
		<div :class="[isFullscreen ? 'flex items-center justify-center flex-col':'', 'lg:w-8/12 w-full px-4 mx-auto mt-8 mb-16 bg-white']" >
			
			<div class="bg-faded_gray h-[25rem] min-w-[57px] w-full grid place-items-center rounded-md " ref="screen" @click="toggle">
