<template>
	<HomeLayout>
		<div
			...
			<h1 class="relative text-2xl md:text-5xl font-bold">Privacy Policy</h1>
		</div>
...
<style scoped>
.pricing_header {
	background: rgba(5, 9, 13, .500) url('@/assets/images/newLanding/privacy_policy_header_banner.png');
