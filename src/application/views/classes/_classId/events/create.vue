	...
	<ClassWrapper>
		<div class="flex flex-col gap-6 mt-6">
			...
			<div class="flex flex-col gap-6 px-4">
				<div class="flex flex-col">
					<ion-label class="font-bold text-sm mb-2">Name</ion-label>
					<IonInput v-model="factory.title" class="w-full border bg-new_gray border-new_gray"
				...
				<div class="flex flex-col">
					<ion-label class="font-bold text-sm mb-2">Date</ion-label>
...
export default defineComponent({
	name: 'ClassClassIdCreateEvents',
	displayName: 'Set up Events',
