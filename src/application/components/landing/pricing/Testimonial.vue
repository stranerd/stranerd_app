...
<template>
	<div class="w-full h-auto flex bg-primaryBg py-4 md:py-8">
		<div
			class="container mx-auto text-bodyText p-6 flex flex-col lg:flex-row gap-6 lg:gap-16 md:items-center justify-center">
			<div
				class="shadow bg-primaryText  w-full max-w-[576px] md:h-[476px] h-[250px] rounded-3xl md:p-8 p-5 flex flex-col justify-between">
