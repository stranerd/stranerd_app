	...
	<Popover>
		<router-link class="flex gap-2 items-center text-gray hover:text-secondaryText border-bottom-line card-padding"
			...
			<div class="w-48 flex items-center gap-3">
				<IonIcon :icon="flashOutline" class="text-3xl" />
		...
		<router-link class="flex gap-2 items-center text-gray hover:text-secondaryText border-bottom-line card-padding"
			...
			<div class="w-48 flex items-center gap-3">
				<IonIcon :icon="readerOutline" class="text-3xl" />
		...
		<router-link class="flex gap-2 items-center text-gray hover:text-secondaryText border-bottom-line card-padding"
			to="/questions/create">
			<div class="w-48 flex items-center gap-3">
				<IonIcon :icon="helpCircleOutline" class="text-3xl" />
				<IonLabel class="font-bold">Ask a question</IonLabel>
			</div>
		</router-link>
		<router-link v-if="user?.isVerified"
			...
			to="/classes/create">
			<div class="w-48 flex items-center gap-3">
				<IonIcon :icon="peopleOutline" class="text-3xl" />
				<IonLabel class="font-bold">Create a class</IonLabel>
			</div>
		</router-link>
	</Popover>
</template>
