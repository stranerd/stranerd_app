<template>
	<div class="bg-primaryBg text-primaryText flex flex-col items-center py-8 gap-8">
		...
		<div class="bg-bodyBg text-primaryBg rounded-full p-2 flex justify-center items-center" @click="openModal">
