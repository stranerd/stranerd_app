	...
	<div
		...
		<div class="flex flex-col pl-8 mt-6">
			<router-link v-for="{ path, icon, name } in [
					{ name: 'homeOutline', path: '/dashboard', icon: homeOutline },
					{ name: 'questions', path: '/questions', icon: helpCircleOutline },
					{ name: 'libraryOutline', path: '/study', icon: libraryOutline }
				]" :key="path" :to="path"
...
import { calendarClearOutline, helpCircleOutline, homeOutline, libraryOutline, peopleOutline } from 'ionicons/icons'
