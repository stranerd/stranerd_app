...
import { addCircle, helpCircle, folder, personCircle, close, home, notifications, school, search, chevronDown, arrowBackOutline } from 'ionicons/icons'
...
export default defineComponent({
	components: { IonIcon,  IonPopover, IonButtons, IonHeader, IonToolbar, IonTitle, SearchBar },
	setup () {
