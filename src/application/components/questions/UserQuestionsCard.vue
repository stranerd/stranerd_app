<template>
	<div :id="question.id" class="py-4 px-4 rounded-lg bg-light_gray flex flex-col w-full text-xs md:text-sm relative cursor-pointer" to="/questions/answers">
		...
		<router-link class="py-2 text-dark_gray leading-normal" :to="`/questions/${question.id}`" >
