<template>
	<div class="w-full flex flex-col bg-bodyBg md:p-4 rounded-xl md:gap-4">
		<div class="p-4 flex flex-col rounded-lg md:border md:border-itemBg border-bottom-line gap-1">
