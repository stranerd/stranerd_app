...
Create your own flashcards or explore the public and save ones you want."
			>
				<div class="flex items-center gap-5">
					<router-link class="py-3 px-7  bg-gray text-white font-bold text-base rounded-xl"
						to="/study/flashCards/create">
						Create Flashcards
					</router-link>
					<router-link class="py-3 px-7 border border-solid border-faded_gray text-gray font-bold text-base rounded-xl"
