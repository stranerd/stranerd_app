<template>
	<div class="d-flex flex-column gap-1 gap-md-2">
		<ion-button  class="w-full font-bold capitalize text-base flex gap-9 justify-center items-center my-6" @click="signup">
			<ion-icon :icon="logoGoogle" size="100px" class="mr-4" />
			<span>Google</span>
		</ion-button>
		<!-- <GoogleLogin
...
export default defineComponent({
	...
	setup () {
		...
		return { googleError, googleLoading, googleSignin, onSuccess, onFailure, logoGoogle }
	}
})
</script>
