<template>
	<div class="flex flex-col gap-4 w-full">
		<IonText class="font-bold text-lg">Suggested actions</IonText>
...
import { arrowForwardOutline, bookOutline, copyOutline, helpCircleOutline } from 'ionicons/icons'</script>
