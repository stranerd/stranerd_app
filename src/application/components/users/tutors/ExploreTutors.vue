	...
	<div class="grid grid-col-6 text-xs md:text-sm  col-span-12">
		<div class="col-span-6 grid grid-cols-6 py-2 ">
			...
			<div class="col-span-6 grid grid-cols-12 md:px-2 px-3 place-items-center">
				<div
					class="py-1 px-2 px-md text-sm col-span-12 md:col-start-4 md:col-end-10 md:mb-3 text-icon_inactive md:min-w-[18.5rem] w-full  bg-light_gray rounded-md md:rounded-md flex flex- mt-2">
					<ion-select v-model="subjectId"
						class="w-full normalText  placeholder-[#8B9EB1] font-bold text-icon_inactive "
