<template>
	<Justified>
		<div>
			<div class="blueTop flex-col items-center pt-5 md:pt-12">

				<div class="flex flex-col w-full justify-center items-center px-4">
					<ion-text class="heading lg:text-2xl font-bold text-white text-center  mt-3 hidden md:block">
						Explore thousands of study materials
					</ion-text>
					<ion-searchbar v-model.trim="searchTerm"
						mode="md"
						:debounce="700"
						class="lg:w-7/12 w-11/12 p-0 lg:mt-8 mt-4 mb-5"
